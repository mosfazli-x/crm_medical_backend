...
export class MessagingService {
  ...
  async sendMessage(
    ...
    if (senderRole === 'patient' && dto.receiver_id) {
      ...
      notificationService.notifyByUser(dto.receiver_id, `\u067E\u06CC\u0627\u0645 \u062C\u062F\u06CC\u062F \u0627\u0632 ${patientName}: ${preview}`, 'message_patient_to_doctor')
      ...
      if (patient?.phone) {
        ...
        notificationService.notifyByPatient(patientId, text, patient.phone, 'message_doctor_to_patient')
      }
    }
