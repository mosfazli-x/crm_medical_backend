...
export async function messagingRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/my-messages', { preHandler: authenticate }, controller.myMessages.bind(controller))
  ...
  fastify.delete<{ Params: { id: string } }>('/:id', { preHandler: authenticate }, controller.deleteMessage.bind(controller))
