...
--> statement-breakpoint
CREATE UNIQUE INDEX "telegram_links_user_id_idx" ON "telegram_links" ("user_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "telegram_links_chat_id_idx" ON "telegram_links" ("chat_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "telegram_link_codes_code_idx" ON "telegram_link_codes" ("code");
--> statement-breakpoint
